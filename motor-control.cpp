...
void intake(double voltage1, double voltage2, double voltage3) {
 // Spin intake motors with specified voltages
   intake_motor1.spin(fwd, voltage1, volt);
   intake_motor2.spin(fwd, voltage2, volt);
   intake_motor3.spin(fwd, voltage3, volt);
}
